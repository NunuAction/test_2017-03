/**
 *  MappingJacksonJsonViewExtends.java
 *
...
/**
 * @ClassName: MappingJacksonJsonViewExtends
 * @Description: 修改MappingJacksonJsonView类contentType以兼容IE6
 * @author Emerson emsn1026@gmail.com
 * @date 2012-3-27 下午03:48:56
 * @version V1.0
 * 
 */
public class MappingJacksonJsonViewExtends extends AbstractView {
	/**
	 ...
	 */
	public MappingJacksonJsonViewExtends() {
	 ...
	 * extended {@link org.codehaus.jackson.map.SerializerFactory} can be configured that provides custom
	 ...
	 * {@linkplain org.codehaus.jackson.JsonEncoding#UTF8 UTF-8} is used.
	 */
	...
	protected void prepareResponse(HttpServletRequest request, HttpServletResponse response) {
		...
		// response.setsetCharacterEncoding(encoding.getJavaName());
		if (disableCaching) {
	 ...
	 * can be either another {@link java.util.Map}, or a single value object.
	 * 
	 * <p>
	 * Default implementation removes {@link org.springframework.validation.BindingResult} instances and
	 * entries not included in the {@link #setRenderedAttributes(java.util.Set)
