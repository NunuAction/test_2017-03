...
public class HttpUtils {
	...
	public static String getHtmlGet(String tempurl, String proxyHost, int proxyPort) {
		return getHtmlGet(tempurl, "utf-8", proxyHost, proxyPort, null, null, null, null);
	}
	...
	public static String fileUpload(String tempurl, String proxyHost, int proxyPort, Part[] parts) {
		return fileUpload(tempurl,proxyHost,proxyPort, null, parts);
	}
	...
	public static String fileUpload(String tempurl, String proxyHost, int proxyPort, Map<String, String> params, Part[] parts) {
		StringBuilder sb = new StringBuilder();
		HttpClient client = new HttpClient();
		client.getHostConfiguration().setProxy(proxyHost, proxyPort);
		client.getHttpConnectionManager().getParams().setConnectionTimeout(60000);
	...
	public static String post(String url,String proxyIp,Integer proxyPort, Map<String, String> params, String xml) {
		String returnData = "";
		if (StringUtils.isNotEmpty(url)) {
			HttpClient client = new HttpClient();
	...
	public static String post(String url,String proxyIp,Integer proxyPort, Map<String, String> params) {
		return post(url,proxyIp,proxyPort, params, null);
	}
