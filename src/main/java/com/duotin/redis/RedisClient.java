...
//    private ZSetOperations<String, Object> zSetOperations;
    ...
    public boolean getDistributedLock(String keyFormat,String... keyValues){
        ...
        try {
            ...
            while (true){
                Boolean getLock=valueOperations.setIfAbsent(key, value);
                if(getLock){
                    //获取锁成功
                    ...
                    while (true){
                        Object t1Object=valueOperations.get(key);
                        long t1,t2=0;
                        if(t1Object!=null){
                            ...
                            if(System.currentTimeMillis()-t1>3000){
                                ...
                                Object t2Object= valueOperations.getAndSet(key, System.currentTimeMillis());
                                if(t2Object!=null){
