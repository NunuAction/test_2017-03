...
public final class WebUtils {
    ...
    public static String narrow100(int src){

        return ""+(src*1.0/100);
    }

    public static String except(int divisor,int dividend){

        String temp = ""+(divisor*1.0/dividend*100);

        DecimalFormat df   = new DecimalFormat("######0.00");
        double aa=Double.parseDouble(temp);

        return df.format(aa);
    }

    public static String except1(int divisor,int dividend){

        String temp = ""+((divisor*1.0/100)/dividend);
