...
import com.duotin.returninfo.KeyValuePair;

/**
 * @author jared
 * @Description:静态常量类
 * @date Nov 7, 2014 5:27:25 PM
 */
public final class ConstUtils {
    ...
    public static final class RedisCache {
        public static final class CachePrefix {
            ...
            public static final String HAS_NEW_SUBCRIBE = "user_has_new_subcribe_";
            public static final String HAS_NEW_LIKE = "user_has_new_like_";
    ...
    public interface Platform {
        ...
        public final static KeyValuePair<String, Integer> ALL = new KeyValuePair<String, Integer>("全部", 0);

        public final static KeyValuePair<String, Integer> IOS = new KeyValuePair<String, Integer>("android", 1);

        public final static KeyValuePair<String, Integer> ANDROID = new KeyValuePair<String, Integer>("ios", 2);
